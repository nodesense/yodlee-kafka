...
public class Invoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static workshop.models.Invoice.Builder newBuilder() {
    return new workshop.models.Invoice.Builder();
  }
   ...
   * @return A new Invoice RecordBuilder
   */
  public static workshop.models.Invoice.Builder newBuilder(workshop.models.Invoice.Builder other) {
    return new workshop.models.Invoice.Builder(other);
  }
   ...
   * @return A new Invoice RecordBuilder
   */
  public static workshop.models.Invoice.Builder newBuilder(workshop.models.Invoice other) {
    return new workshop.models.Invoice.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Invoice>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(workshop.models.Invoice.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(workshop.models.Invoice other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setQty(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearQty() {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setState(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setCountry(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearCountry() {
      country = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder setInvoiceDate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public workshop.models.Invoice.Builder clearInvoiceDate() {
